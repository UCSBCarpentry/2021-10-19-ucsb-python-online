...
humandate: "Oct 19-22, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Greg Janee", "Isaac Park", "Ian Lessing"]  # boxed, comma-separated list of instructors' names as strings, like ["Jon Jablonski"]
helper: ["Jean Allen", "Melanie Leung", "Jon Jablonski", "Kristi Liu", "Amanda Ho"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2021-10-19-ucsb-python-online  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "170060077269" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<a href="https://www.timeanddate.com/worldclock/fixedtime.html?msg=Git%2FBash%2FPython&iso=20210917T08&p1=1050">Check what time registration opens in your time
zone</a>
...
<p id="requirements">
  ...
  {% if online == "false" %}
    ...
    Mac, Linux, or Windows operating system <b>(not a tablet, Chromebook, etc.)</b> that they have administrative privileges on.
  {% else %}
